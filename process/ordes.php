...
if ($method === "GET") {
    ...
    // adicionar o arrayda pizza ao array das pizzas
...
if ($type === "delete") {
  ...
  // retorno do usuario para dashboard
  header("Location: ../dashboradpedido.php");
